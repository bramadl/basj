  ...
  plugins: [
    plugin(function ({ addUtilities }: { addUtilities: any }) {
      addUtilities({
        ...
        ".text-desktop-p-700": { font: "700 18px/24px Kollektif, sans-serif" },
        ".text-desktop-p-400": { font: "400 18px/24px Kollektif, sans-serif" },
        ".text-desktop-b1-700": { font: "700 16px/20px Kollektif, sans-serif" },
        ".text-desktop-b1-400": { font: "400 16px/20px Kollektif, sans-serif" },
        ".text-desktop-b2-700": { font: "700 14px/16px Kollektif, sans-serif" },
        ".text-desktop-b2-400": { font: "400 14px/16px Kollektif, sans-serif" },
        ".text-desktop-sm-700": { font: "700 12px/14px Kollektif, sans-serif" },
        ".text-desktop-sm-400": { font: "400 12px/14px Kollektif, sans-serif" },
        /** Mobile typography */
        ...
        ".text-mobile-p-700": { font: "700 16px/20px Kollektif, sans-serif" },
        ".text-mobile-p-400": { font: "400 16px/20px Kollektif, sans-serif" },
        ".text-mobile-b1-700": { font: "700 14px/16px Kollektif, sans-serif" },
        ".text-mobile-b1-400": { font: "400 14px/16px Kollektif, sans-serif" },
        ".text-mobile-b2-700": { font: "700 12px/14px Kollektif, sans-serif" },
        ".text-mobile-b2-400": { font: "400 12px/14px Kollektif, sans-serif" },
        ".text-mobile-sm-700": { font: "700 10px/12px Kollektif, sans-serif" },
        ".text-mobile-sm-400": { font: "400 10px/12px Kollektif, sans-serif" },
      });
    }),
