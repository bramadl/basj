  ...
  return (
    <div className="flex md:grid lg:flex md:grid-cols-3 items-center justify-center gap-x-14 gap-y-8 flex-wrap">
      <div className="flex items-center gap-14">
        <Image
          alt="Bureau veritas"
          className="client-list-image opacity-0 object-cover grayscale w-[90px] h-[110px]"
        ...
        <Image
          ...
          className="client-list-image opacity-0 object-cover grayscale w-[146px] h-[98px]"
      ...
      <Image
        ...
        className="client-list-image opacity-0 object-cover grayscale w-[188.67px] h-[80px]"
