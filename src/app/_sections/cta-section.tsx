...
export const CtaSection: FC = () => {
  return (
    ...
    >
      <div className="flex py-10 px-8 md:py-20 md:px-[200px] flex-col justify-center items-center gap-6 md:gap-7 self-stretch md:self-auto rounded-[20px] md:rounded-[40px] bg-[rgba(176,93,36,0.40)] backdrop-blur-[5px] text-primary-white">
        <h2 className="text-center text-mobile-h3-400 md:text-desktop-h3-400">
          <strong className="text-mobile-h3-700 md:text-desktop-h3-700">Ready to make change?</strong>{" "}
          Let&apos;s be partner.
        </h2>
